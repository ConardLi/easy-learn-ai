...
| 提示词工程 | **[轻松理解 Prompt](https://mmh1.top/#/ai-knowledge/prompt)** - 人和模型沟通任务意图的指令文本，是使用大模型的第一入口 | ✅  |
| 提示词工程 | **[轻松理解 System Prompt](https://mmh1.top/#/ai-knowledge/system-prompt)** - 用来设定模型的角色、边界、语气和优先规则 | ✅  |
| 提示词工程 | **[轻松理解 Few-shot Learning](https://mmh1.top/#/ai-knowledge/few-shot)** - 通过给模型几个示例，让模型模仿格式和思路完成新任务 | ✅  |
| 提示词工程 | **[轻松理解 Chain of Thought](https://mmh1.top/#/ai-knowledge/chain-of-thought)** - 让模型显式拆解推理步骤，提升复杂问题的解题稳定性 | ✅  |
...
| 压缩部署 | **轻松理解 Prompt Cache** - 通过缓存高频提示词的中间计算结果，显著降低推理成本与响应延迟 | 👷 |
