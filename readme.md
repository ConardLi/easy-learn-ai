...
| Agent | **轻松理解 上下文压缩** - 在 Context Window 有限时，保留关键信息、压缩历史内容 | 👷 |
| Agent | **轻松理解 工具调用** - Agent 通过调用搜索、代码、数据库等工具，把想法变成行动 | 👷 |
| Agent | **轻松理解 多智能体协作** - 多个 Agent 分工合作，比如规划、执行、审查、总结 | 👷 |
...
| Agent | **轻松理解 Agent 可观测性** - 记录并分析 Agent 的执行过程 | 👷 |
