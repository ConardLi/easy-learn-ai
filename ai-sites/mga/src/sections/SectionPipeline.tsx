...
const STEPS = [
  {
    ...
    icon: CircleDot,
    body: "把原文喂给 3.3B 的 MoE 模型，让它读完之后自己决定『这篇适合写给谁、用什么文体』。",
    detail: [
      "不依赖外部 seed 库 — 每篇文章生成的 5 对配对，是基于内容本身适配出来的。",
      "一次推理出齐 5 组，覆盖知识深度、表达风格、读者背景三个维度。",
      "整篇过程只占轻量算力 — 3.3B MoE，激活参数远低于 dense 模型。",
    ],
    output: [
      "学术综述 · 气候研究者",
      "亲子科普 · 8-10 岁学生",
  ...
  },
  {
    ...
    icon: Scale,
    body: "另起一个 judge 模型，对每个改写版本打分 1-5。低于 3 分丢弃。",
    detail: [
      "判分标准不是『字面相似』 — 允许风格差异、结构调整。",
      "判分标准是『核心信息可追溯回原文』 — 不能瞎编新事实。",
      "通过的样本进入最终 MGACorpus，被 dropout 的样本不再投入训练。",
    ],
    output: [
      "v01 学术 · 4.6 ✓",
      "v02 故事 · 4.2 ✓",
