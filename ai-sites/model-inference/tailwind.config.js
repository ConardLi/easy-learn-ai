...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['"Plus Jakarta Sans"', '"Noto Sans SC"', "-apple-system", "BlinkMacSystemFont", '"PingFang SC"', "system-ui", "sans-serif"],
        display: ['"Smiley Sans"', '"Plus Jakarta Sans"', '"Noto Sans SC"', "-apple-system", "BlinkMacSystemFont", '"PingFang SC"', "system-ui", "sans-serif"],
      ...
      animation: {
        ...
        "enter-pop": "enterPop .7s cubic-bezier(.34,1.56,.64,1) both",
        "enter-up": "enterUp .85s cubic-bezier(.22,1,.36,1) both",
      ...
      keyframes: {
        ...
        floatYSm: { "0%,100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-4px)" } },
        wiggle: { "0%,100%": { transform: "rotate(-3deg)" }, "50%": { transform: "rotate(3deg)" } },
        enterPop: { "0%": { opacity: "0", transform: "scale(.3)" }, "60%": { opacity: "1", transform: "scale(1.12)" }, "100%": { opacity: "1", transform: "scale(1)" } },
        enterUp: { "0%": { opacity: "0", transform: "translateY(50px) scale(.7)" }, "100%": { opacity: "1", transform: "translateY(0) scale(1)" } },
        enterFade: { "0%": { opacity: "0" }, "100%": { opacity: "1" } },
        pulseDot: { "0%,100%": { opacity: ".6", transform: "scale(.9)" }, "50%": { opacity: "1", transform: "scale(1.15)" } },
