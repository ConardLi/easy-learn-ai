        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="max-w-md space-y-3 text-[15px] text-ink/75 leading-relaxed animate-enter-fade">
              <p>
                pre-train 之后的 base 模型，本质上是一台 token 续写机：你给它「今天天气」，它给你「不错，适合出门」。
              </p>
              <p>
                SFT 就是接着拿几千到几十万条人写的（指令，回答）对，再训一遍 —— 训完它就懂了：用户输入一个问题，应该用「回答」的姿势接话，而不是接着写。
              </p>
              <p>
                训练流水线第二阶段。第一阶段叫 pre-train，第三阶段叫 RLHF / DPO。
              </p>
            </div>
