  ...
  return (
    <section className="relative px-4 sm:px-6 lg:px-8 py-20 lg:py-24 bg-cream">
      <div className="max-w-6xl mx-auto">
        ...
        {/* 互链：上面提到的另外两种格式 */}
        <div className="mt-4 grid sm:grid-cols-2 gap-4 max-w-3xl">
          <a
            href="../safetensors/index.html"
            className="flex items-start gap-3 card-stamp p-4 bg-white hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all duration-250 ease-spring"
          >
            <span className="flex-shrink-0 w-7 h-7 rounded-full bg-white border-2 border-ink flex items-center justify-center mt-0.5">
              <ExternalLink className="w-3.5 h-3.5 text-ink" />
            </span>
            <span className="text-[13px] leading-relaxed text-ink/80">
              <span className="font-semibold text-ink">Safetensors →</span> 训练微调常用的权重格式，跟 GGUF 经常一起出现。
            </span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-[13px] leading-relaxed text-ink/80">
              <span className="font-semibold text-ink">ONNX →</span> 想跨硬件、跨框架部署时用的通用格式。
            </span>
          </a>
        </div>
